...
<ul class="nav nav-tabs">
	<li role="presentation"  class="active"><a href="/PFAGestionNote/Coordinateur/">Accueil</a></li>
...
<legend>Bonjour: ${coordinateur.nom}</legend>
<div  align="center" >
	<p>Vous etes coordinateur : Departement ${coordianteurchefDepartement.departement.nom}</p>
</div>
</div>
</fieldset>
