...
<a href="add/module/${section.id}"><button style="width: 80px;margin-left: 1100px;margin-top: 10px;">Ajouter Module</button></a>
...
<c:forEach items="${listModules}" var="module">
        <tr style="background-color: #D1CECD">
        	...
        	<td><a href="add/matiere/${module.id}">Ajouter Matière</a></td>
        </tr>
<div align="center">
   			<div align="center" style="width: 300px">

          <c:forEach items="${listMatieres}" var="matiere">
          <c:if test="${matiere.mId == module.id }">
        <tr>
