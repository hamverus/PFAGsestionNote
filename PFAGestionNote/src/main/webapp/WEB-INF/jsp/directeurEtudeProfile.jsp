...
<ul class="nav nav-tabs">
	...
	<li role="presentation" class="active"><a href="/DirecteurEtude/Profile">Profile</a></li>
...
<a href="etudiant/edit/${directeurEtude.id}"><button style="width: 120;margin-left: 1100px;margin-top: 10px;">Modifier Profile</button></a>
...
<div  align="center" >
    ...
    <table align="center">
        ...
        <tr><th width="400">Nom : ${directeurEtude.nom}</th></tr>
        <tr><th width="400">Prenom : ${directeurEtude.prenom}</th></tr>
        <tr><th width="400">Email : ${directeurEtude.email }</th></tr>
        <tr><th width="400">Telephone : ${directeurEtude.tel }</th></tr>
        <tr><th width="400">Numero d'inscrit : ${directeurEtude.numMatricule }</th></tr>
