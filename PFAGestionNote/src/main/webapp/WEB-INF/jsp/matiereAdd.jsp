...
<br><br>
<form:form action="/PFAGestionNote/matiere/add" method="POST" commandName="matiere" class="form-group">
<fieldset>
 <legend>Ajout Matiere</legend>
 <div align="center">
    <div align="center" style="width: 300px">
			<form:hidden path="id" />
			<p><b>Nom de matiere:</b></p>
			<form:input path="nom" class="form-control"/><br>
			<p><b>Nombre d'heures:</b></p>
			<form:input path="nbHeures" class="form-control"/><br>
			<p><b>Coefficient:</b></p>
			<form:input path="coefficient" class="form-control"/><br>
			<p><b>Semestre:</b></p>
			<form:input path="semestre" class="form-control"/><br>
