...
<ul class="nav nav-tabs">
	<li role="presentation"  class="active"><a href="/PFAGestionNote/">Accueil</a></li>
...
<legend>Bonjour: ${coordinateur.nom}  ${coordinateur.prenom}</legend>
<div  align="center" >
	<p>Vous etes coordinateur : Departement ${coordinateur.departement.nom}</p>
</div>
</div>
</fieldset>
