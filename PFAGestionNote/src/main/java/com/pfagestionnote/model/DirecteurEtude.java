...
/**
 * DirecteurEtude generated by hbm2java
 */
@Entity
@Table(name = "directeur_etude", catalog = "gestion_scolarite")
public class DirecteurEtude implements java.io.Serializable {
	...
	public DirecteurEtude(String nom, String prenom, String email, Long tel,
			String login, String mdp, String numMatricule) {
		this.nom = nom;
		this.prenom = prenom;
		this.email = email;
		this.tel = tel;
